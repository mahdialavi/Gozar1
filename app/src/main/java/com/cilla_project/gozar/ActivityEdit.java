...
//                        }
    ...
    private com.squareup.picasso.Target target3 = new com.squareup.picasso.Target() {
        ...
        @Override
        public void onPrepareLoad(Drawable placeHolderDrawable) {
            imgselect3.setImageResource(R.drawable.noimage);
    ...
    private com.squareup.picasso.Target target2 = new com.squareup.picasso.Target() {
        ...
        @Override
        public void onPrepareLoad(Drawable placeHolderDrawable) {
            imgselect2.setImageResource(R.drawable.noimage);
    ...
    private void showOrHideImageViews() {
        if (!imglogo.equals("")) {
            ...
            Picasso.with(this).load(G.IMAGE_URL + imglogo).placeholder(R.drawable.noimage).into(target1);
            ...
            if (imglogo2!=null&& !imglogo2.equals("")) {
                ...
                Picasso.with(this).load(G.IMAGE_URL + imglogo2).placeholder(R.drawable.noimage).into(target2);
            ...
            if (!imglogo3.equals("")) {
                ...
                Picasso.with(this).load(G.IMAGE_URL + imglogo3).placeholder(R.drawable.noimage).into(target3);
