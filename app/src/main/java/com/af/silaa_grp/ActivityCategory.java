...
//        }
    ...
    private void showFailedView(boolean show, String message) {
        ...
        ((CustomTextView) lyt_failed.findViewById(R.id.failed_message)).setText(message);
        if (show) {
        ...
        lyt_failed.findViewById(R.id.failed_retry).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                requestAction("category",citycode,catid);
            }
