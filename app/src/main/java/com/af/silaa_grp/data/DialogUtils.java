...
public class DialogUtils {
    ...
    public Dialog buildDialogInfo(@StringRes int title, @StringRes int content, @StringRes int bt_text_pos,@StringRes int bt_text_neg, @DrawableRes int icon, final CallbackDialog callback) {
        return buildDialogInfo(activity.getString(title), activity.getString(content), activity.getString(bt_text_pos),activity.getString(bt_text_neg), icon, callback);
    }
    ...
    public Dialog buildDialogInfo(String title, String content, String bt_text_pos, String bt_text_neg, @DrawableRes int icon, final CallbackDialog callback) {
        ...
        ((CustomTextView) dialog.findViewById(R.id.tozih)).setText(title);
        ((CustomTextView) dialog.findViewById(R.id.txtyes)).setText(bt_text_pos);
        ((CustomTextView) dialog.findViewById(R.id.txtno)).setText(bt_text_neg);
