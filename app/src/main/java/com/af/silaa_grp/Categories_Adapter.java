...
public class Categories_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private Categories_Adapter.OnLoadMoreListener onLoadMoreListener;

    public static ArrayList<JobItemsList> itemsArraylist = new ArrayList<>();


    public Categories_Adapter(Context context, RecyclerView view) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            ...
            vh = new Categories_Adapter.OriginalViewHolder(v);
        } else {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_loading, parent, false);
            vh = new Categories_Adapter.ProgressViewHolder(v);
        }
        return vh;
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof Categories_Adapter.OriginalViewHolder) {
    ...
    public void setOnLoadMoreListener(Categories_Adapter.OnLoadMoreListener onLoadMoreListener) {
