...
public class Activity_Sale extends ActivityEnhanced {
    RecyclerView rvItems;
    LinearLayoutManager manager;
    Sale_Item_Adapter itemsAdapter;
    ...
    CustomTextView txtcatname,btnsabt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemsAdapter = new Sale_Item_Adapter(G.Context,rvItems);
        ...
        requestAction("getkhrid_forosh",1,catid);
...
//                if (callbackCall != null && callbackCall.isExecuted()) callbackCall.cancel();
        ...
        itemsAdapter.setOnLoadMoreListener(new Sale_Item_Adapter.OnLoadMoreListener() {
            @Override
        ...
        rvItems.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0 && btnsabt.getVisibility() == View.VISIBLE) {

                    btnsabt.setVisibility(View.GONE);
                } else if (dy < 0 && btnsabt.getVisibility() != View.VISIBLE) {
